    ...
    return (
        <div>
            ...
            <div className='flex justify-center mt-20'>
                <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-white shadow-xl text-gray-100">
                    <h1 className="text-2xl font-bold text-center text-gray-700">Login</h1>
                    <form novalidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
                    <div className="space-y-4">
                        <div>
                            <label for="email" className="block mb-2 text-sm text-gray-300">Email address</label>
                        ...
                        <button className="block w-full p-3 text-center rounded-md bg-emerald-600 text-white">Sign in</button>
                    </form>
                    ...
                    <div className="flex justify-center item-center space-x-4">
                        <button aria-label="Log in with Google" className="p-3 rounded-full bg-gradient-to-r from-red-600 to-blue-700">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                                <path d="M16.318 13.714v5.484h9.078c-0.37 2.354-2.745 6.901-9.078 6.901-5.458 0-9.917-4.521-9.917-10.099s4.458-10.099 9.917-10.099c3.109 0 5.193 1.318 6.38 2.464l4.339-4.182c-2.786-2.599-6.396-4.182-10.719-4.182-8.844 0-16 7.151-16 16s7.156 16 16 16c9.234 0 15.365-6.49 15.365-15.635 0-1.052-0.115-1.854-0.255-2.651z"></path>
                            </svg>
                        </button>
                        <button aria-label="Log in with Twitter" className="p-3 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                        ...
                        <button aria-label="Log in with GitHub" className="p-3 rounded-full bg-gradient-to-r from-gray-800 to-gray-600">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
